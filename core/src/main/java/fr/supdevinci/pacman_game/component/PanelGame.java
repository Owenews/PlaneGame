...
import fr.supdevinci.pacman_game.obj.Bullet;
import fr.supdevinci.pacman_game.obj.Effect;
import fr.supdevinci.pacman_game.obj.Player;
import fr.supdevinci.pacman_game.obj.Rocket;
import fr.supdevinci.pacman_game.obj.sound.Sound;
...
public class PanelGame extends JComponent {
    ...
    // Game FPS (Frames Per Second) and target time per frame
    ...
    /**
     * Starts the game by initializing objects, threads, and rendering.
     */
    public void start() {
        width = getWidth();
        height = getHeight();
    ...
    /**
     * Adds rockets to the game at random positions.
     */
    ...
    /**
     * Initializes game objects such as the player, rockets, and effects.
     */
    ...
    /**
     * Initializes the bullets list and starts a thread to manage bullet updates.
     */
    ...
    /**
     * Checks for collisions between the player and rockets.
    ...
    /**
     * Draws the game objects such as the player, bullets, rockets, and effects.
     */
     ...
     * @param speed The duration to sleep in milliseconds.
     */
